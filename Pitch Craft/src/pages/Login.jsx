  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-12">
      <div className="pitch-container max-w-md w-full p-8 bg-white shadow-xl rounded-xl border border-gray-200">
        <h2 className="text-3xl font-extrabold mb-8 text-center text-gray-800">Login to PitchCraft</h2>
        ...
        <p className="mt-6 text-center text-md text-gray-500">
          New here? <a href="/register" className="text-blue-600 hover:text-blue-800 font-medium transition duration-150">Register</a>
        </p>
      </div>
    </div>
  )
